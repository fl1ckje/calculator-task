...
class NumberConverter {
    ...
    подходит хеш-таблица, в которой местоположение элемента зависит от значения самого элемента. Однако в реальных
    задачах чаще порядок вставки значений в таблицу имеет случайный порядок, в неотсортированном виде
    */
